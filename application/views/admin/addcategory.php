...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1> Add Categories<small>Add Categories...</small> </h1>
        <ol class="breadcrumb">
                                    ...
                                    <br>
                                      ...
                                      if(isset($message)){ ?>
                                          <div class="alert alert-success alert-dismissible" role="alert">
                                              ...
                                              Category has been added successfull!
                                          </div>
                                      <?php }
                                      ?>
                                    <!-- form start -->
                                    <div class="box-body">
                                        <form action="<?php echo site_url('admin/category/addnewcategory') ?>" method="POST" enctype="multipart/form-data" class="form-horizontal form-validate">
                                            <div class="form-group">
                                                <label for="name" class="col-sm-2 col-md-3 control-label">Nme (English)</label>
                                                <div class="col-sm-10 col-md-4">
                                                    <input type="text" name="categoryName_en" class="form-control field-validate" required>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-4">
                                                        <input type="text" name="categoryName_cn" class="form-control field-validate" required>
